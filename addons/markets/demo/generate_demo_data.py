...
# Utility Accounts (from general - these should exist)
# 6 accounts total: 3 electricity + 3 water (for 30 stalls, max 5 per account)
# Using full external ID format: module.record_id
UTILITY_ACCOUNTS = [
    ('general.utility_account_meralco_001', 'electricity'),
    ('general.utility_account_meralco_002', 'electricity'),
    ('general.utility_account_meralco_003', 'electricity'),
    ('general.utility_account_water_001', 'water'),
    ('general.utility_account_water_002', 'water'),
    ('general.utility_account_water_003', 'water'),
]
